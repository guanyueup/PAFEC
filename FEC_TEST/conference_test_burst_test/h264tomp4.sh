...
# 输入文件夹
input_dir="/home/zzp/FEC_Test/conference_test_burst_test"
...
do
    ...
    ffmpeg -fflags +genpts -err_detect ignore_err -ec guess_mvs+deblock+favor_inter -r 25 -i "$file" -c:v copy "$output_file" -y
